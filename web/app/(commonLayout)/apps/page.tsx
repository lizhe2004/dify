    ...
    <div className='relative flex flex-col overflow-y-auto bg-gray-100 shrink-0 h-0 grow'>
      ...
      <footer className='px-12 py-6 grow-0 shrink-0'>
        ...
        <div className='flex items-center gap-2 mt-3'>
          <a className={style.socialMediaLink} target='_blank' rel='noopener noreferrer' href='https://github.com/lizhe2004/dify'><span className={classNames(style.socialMediaIcon, style.githubIcon)} /></a>
